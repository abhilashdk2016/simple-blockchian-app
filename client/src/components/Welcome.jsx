...
const Input = ({ placeholder, name, type, value, handleChange}) => (
    <input 
        placeholder={placeholder} type={type} name={name} step="0.0001" value={value} onChange={e => handleChange(e, name)}
                ...
                <div className='flex flex-1 justify-start flex-col mf:mr-10'>
                    ...
                    { 
                        !currentAccount && <button type='button'
                            ...
                            className='flex flex-row justify-center items-center my-5 bg-[#2952e3] p-3 rounded-full cursor-pointer hover:bg-[#2546be]'
